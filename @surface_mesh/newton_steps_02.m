...
% % % % % %  to take the shortes dS possible. So dS can be written as dS = J.dV, and dV is obtained
...
% % % % %     
% % % % %     %%% we need triangle areas (Areas) at current configuration.
...
% % % % %     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % % 
% % % % %     %%% we need the Jacobian (J) at  current step. J is a (N-4) x N matrix
...
% % % % %        axis square;view(-276,4);zoom(1);drawnow;
% % % % %    end
% % % % %    
% % % % % 
% % % % % end
