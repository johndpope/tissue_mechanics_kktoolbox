...
phys.kb = 2e-2; %units in joule
phys.k_stretch = 1e0;%1e-20;%   set to artificially weak membrane to keep the triangles from shearing. was 5e-18;
...
save results_snl_w1_203_10 L_max gdim X_o_res_vec s_master phys pos Y_LK_vm
