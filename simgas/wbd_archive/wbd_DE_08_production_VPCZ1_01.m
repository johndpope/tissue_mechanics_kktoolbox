...
DEL_el_sq = 0.4^2;%0.28^2; %large values make bending harder, low make shear harder
phys.kb = 1; %units
...
elseif optim_method == 2
    ...
    [X_o_res_vec, E_vec, exitflag_vec] = combi_optim_02(X_o,phys,s_master,pos, Y_LK_vm, mcmc_options,options, model_fun, constraints_fun);
     
end
save results_snl_w1_11 L_max gdim X_o_res_vec s_master phys pos Y_LK_vm exitflag_vec
