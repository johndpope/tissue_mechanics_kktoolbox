...
L_max = 5;           % maximum order of the spherical harmonics parameterization
L_max_gef = 5;
gdim = 15;
optim_method = 2;
pos = [ 0 0 0];
...
phys.k_stretch = 1e-2;%1e-20;%   set to artificially weak membrane to keep the triangles from shearing. was 5e-18;
...
save Time_seq_results_02_w1 L_max gdim X_o_res_vec s_master phys pos Y_LK_vm
