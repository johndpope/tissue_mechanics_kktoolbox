...
E = phys.lambda/2*log(detF.^2) + phys.miu/2.*(trFTF-3)-phys.miu/2.*log(detF); % Strain energy as in Conte et al.2007
E = sum(E.*w.*SSn);     % perform the integration
%% Reporting II
disp(['---------------- Bending energy -----------']);
