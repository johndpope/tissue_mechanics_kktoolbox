...
kk_plot3(X);
% subplot(1,2,1);
axis equal;axis off;axis tight;view(0,0);


% % H = reshape(H,size(x));
% % subplot(1,2,2);surf(x,y,z,double(H), 'EdgeColor', 'none');
% % axis equal;axis off;axis tight;view(0,0);lighting flat;camlight;
% % view(3);axis equal;axis on;axis tight;camlight;lighting gouraud;light;
