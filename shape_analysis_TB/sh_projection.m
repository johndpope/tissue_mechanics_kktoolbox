function [A, V, h, v, xclks, yclks, zclks] = sh_projection(gdim, xL_max, yL_max, zL_max, x, y, z, t, p, plotflag, shape_prop)
...
A  = zeros(N, M);
for S = 1:length(L), A(:,S) = ylk_cos_sin(L(S),K(S),p,t)';end;warning off MATLAB:divideByZero;
