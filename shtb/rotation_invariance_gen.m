function [X_o,xrot, yrot,zrot,g,b,a ] = rotation_invariance_gen(clks)
...
%%%%%%
% cr = Rg*C;
xrot2 = [0 cr(1,2:end)];yrot2 = [0 cr(2,2:end)];zrot2 = [0 cr(3,2:end)];
X_o = [xrot2(:)' yrot2(:)' zrot2(:)'];
plot_sh(xrot2,yrot2,zrot2,20);axis on; view(52,23);
