function [A, V,h,T, dA, E, H, wp, wt, p, t]  = plot_sh_notri_p(X_o, gdim)
...
if plotflag, surf(x,y,z,double(p), 'EdgeColor', 'none');axis equal;axis tight; lighting gouraud;light;end
