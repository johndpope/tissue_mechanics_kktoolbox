function [A, V,h,T, dA, E, H, wp, wt, p, t]  = plot_sh_notri_t(X_o, gdim)
...
if plotflag, surf(x,y,z,double(t), 'EdgeColor', 'none');axis equal;axis tight; lighting gouraud;light;end
