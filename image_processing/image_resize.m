...
%   Just put in the new dimensions in pixels
...
% %     whos
    ...
    if strcmp(imtype, 'uint16'), newimg = uint16(round(mat2gray(newimg)*65535)); else, newimg = uint8(round(mat2gray(newimg)*255));end
    return; 
end 
